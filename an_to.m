...
for NCOND=1:length(Conditions)
    ...
    for NBT=1:length(Turnovers)
        ...
        for run = 1:nruns
            ...
            csum2=sum((recallspikes(1,:)>10 ) & (recallspikes(2,:)>10))
            csum3=sum((recallspikes(1,:)>10 ) & (recallspikes(3,:)>10))
            csum4=sum((recallspikes(1,:)>10 ) & (recallspikes(4,:)>10))
